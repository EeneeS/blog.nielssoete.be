export const POSTS = [
    {
        ...
        content: `
            ...
            At the heart of Combell's premium hosting lies a sophisticated infrastructure intelligently distributing 
            computing power across multiple servers. In the event of one server's failure, another seamlessly takes over. <br/> <br/>
...
`,
    ...
    },
    {
        ...
        content: `
            ...
            role of AI. The lecture focused on the different stages of SEO, ranging from research to website development. <br/> <br/>
            One fascinating aspect of SEO is the strategic use of synonyms and context, as exemplified by Bol.com's product descriptions. <br/> <br/>
            Various techniques, such as wireframes and keyword utilization, play essential roles in optimizing a website. The lecture 
    ...
    },
    {
        ...
        content: `
            ...
            . Then, he pointed out some key differences between Node.js and Deno. <br/> <br/>
            He made things easy to understand by showing us demos. Casier demonstrated how simple it is to use openAI 
            with Deno. He walked us through different scripts that automate tasks, saving a lot of time and money. 
            The most impressive one was using the vision API to turn a hand-drawn image into a SQLite database. That's pretty amazing! <br/> <br/>
            When we ask a machine to do something, we expect it to be perfect. But now, with 
            models like openAI, the answers are about 80% correct. Casier reminded us that it's okay 
